...
BuilDeck은 "있고 없고"라는 간단한 규칙에 전략적인 깊이를 더한 카드 배틀 게임입니다. 플레이어는 매 턴 제시되는 카드들 중 규칙에 맞는 카드를 선택하여 자신의 덱을 구성하고, 강력한 덱을 만들어 상대방과의 전투에서 승리해야 합니다.
...
| 인게임 | 승리 화면 |
| :---: | :---: |
| ![인게임 화면](./기타%20자료/인게임.png) | ![승리 화면](./기타%20자료/인게임%20승리.png) |

| 모바일 | 태블릿 |
| :---: | :---: |
| ![모바일 화면](./기타%20자료/모바일.png) | ![태블릿 화면](./기타%20자료/태블릿.png) |
...
본 프로젝트는 [MIT 라이선스](LICENSE)를 따릅니다. (라이선스 파일 추가 예정)

---
*이 README는 Gemini를 통해 생성되었습니다.*
